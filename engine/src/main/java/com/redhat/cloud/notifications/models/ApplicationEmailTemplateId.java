...
@Embeddable
public class ApplicationEmailTemplateId implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (o instanceof ApplicationEmailTemplateId) {
            ApplicationEmailTemplateId other = (ApplicationEmailTemplateId) o;
