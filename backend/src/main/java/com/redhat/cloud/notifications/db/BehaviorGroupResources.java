...
public class BehaviorGroupResources {
    ...
    private BehaviorGroup create(String accountId, BehaviorGroup behaviorGroup, boolean isDefaultBehaviorGroup) {
    ...
    private Boolean update(String accountId, BehaviorGroup behaviorGroup, boolean isDefaultBehavior) {
        try {
